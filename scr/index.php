...
<div style="min-height: 50px;">
    ...
    <!-- ================================================== -->
    <div id="slider1_container" style="display: none; position: relative; margin-top: 50px;
...
<div id="conteinerMarketing" class="container marketing shadowStyle"><!-- BG COLOR-->
  ...
  ============================================================================================= -->
    ...
    <div class="head_title">
        ...
        <h3><i>Accommodation Auction</i></h3></p>
        <hr>
    ...
    <p>
        Καλώς ήρθατε στο Accommodation Auction.<br>
        Ένα site το οποίο πραγματοποιήθηκε με σκοπό την δημοπρασία Ξενοδοχειακών μονάδων.
        <br> Είστε απλός θεατής;
        Είστε επιχειρηματίας ;<br>
        Τοτέ το Accommodation Auction είναι το κατάλληλο site για σάς
        Με πάνω απο 2201 ξενοδοχειακές μόνάδες σε όλη την Ελλάδα το Accommodation Auction είναι εδώ για να σας προσφέρει
        τις καλύτερες προσφορές της αγοράς, με την
        καλύτερη δυνατή ποιότητα.<br>
        Για περισσότερες πληροφορίες επισκευτήτε την σελίδα μας, "Σχετικά με το Site"
