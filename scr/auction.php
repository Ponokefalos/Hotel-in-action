...
<head>
    ...
    <link href="../css/auctionStyle.css" rel="stylesheet">
  ...
  ============================================================================================= -->
    ...
    <div class="head_title">
        <div class="addNewElement">
            ...
            echo '<button onclick="location.href =' . "'newAuctionForm.php'" . '"; type="submit" class="btn btn-primary" >+ Νέα Δημοπρασία</button>';
    ...
    <div>
        <div id="auction" class="container marketing ">
            <p>Παρακάτω βλέπετε όλες τις τελευταίες δημοπρασίες</p> <br>
