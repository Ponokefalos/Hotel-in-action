  ...
  ============================================================================================= -->
    ...
    <div id="auction">
        <div class="row">
            ...
            <div id="details" class="col-md-6">
                ...
                <div id="short-description">
                    ...
                    <p id="auctionTimeRemaining"> 4 Ημέρες 23 Ωρες 43 Λεπτά </p>
                    <br>
                    <p>Τελευταία Προσφορά: 73.00 <span>€</span></p>
                    <br>
                    <form class="form-inline">
                        <div class="form-group">
        ...
        <div id="full-description">
            <p> <h4>Περιγραφή</h4>
            Τα κλιματιζόμενα δωμάτια του Nefeli είναι επιπλωμένα σε παραδοσιακό στιλ. Διαθέτουν όλα μπαλκόνι και είναι εξοπλισμένα με τηλεόραση, ψυγείο και τηλέφωνο.
